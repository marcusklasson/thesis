...
%%% Contents
\input{PaperB/sections/introduction}
\input{PaperB/sections/results}
\input{PaperB/sections/discussion}
\input{PaperB/sections/experimental_procedures}

\begin{appendices}
	\input{PaperB/appendix/supplemental_figures}
	
	%\newpage
	
	\section*{Supplemental Experimental Procedures}
	\input{PaperB/appendix/details_on_experimental_setup}
	
	\input{PaperB/appendix/posterior_collapse_in_vcca_private}
	
	\input{PaperB/appendix/investigating_latent_representations_in_vcca_private_xi}
	
	\input{PaperB/appendix/derivation_of_elbo_for_vcca}
\end{appendices}
%\appendix
