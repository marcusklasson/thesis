...
%%% Figure 3
\input{figures_and_tables/figure3}

In Klasson \etal~\cite{klasson2019hierarchical}, we collected images from fruit, vegetable, and refrigerated sections with dairy and juice products in 20 different grocery stores.
...
%%% Figure 4
%\input{figures_and_tables/figure4}
\input{figures_and_tables/figure4_new}
...
%%% Figure 5
\input{figures_and_tables/figure5}

\input{figures_and_tables/figure6}
...
%%% Figure 7
\input{figures_and_tables/figure7}
...
%%% Figure 8
\input{figures_and_tables/figure8}
...
%%%% Figure 9
\input{figures_and_tables/figure9}
...
\input{figures_and_tables/figure10_new}
