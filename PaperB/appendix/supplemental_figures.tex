...
\begin{figure}[t!]
    ...
    \begin{minipage}[t]{\textwidth}
        \centering
         \subfigure[VAE$_{x}$]{\label{fig:tikz_vae_x}\input{PaperB/appendix/figures/tikz_figures/vae_x}} ~~~~ \subfigure[VCCA$_{x y}$]{\label{fig:tikz_vcca_xy}\input{PaperB/appendix/figures/tikz_figures/vae_xy}}
         ~~~~  
         \subfigure[VCCA$_{x i}$]{\label{fig:tikz_vcca_xi}\input{PaperB/appendix/figures/tikz_figures/vcca_xi}}
         ~~~~  
         \subfigure[VCCA$_{x i y}$]{\label{fig:tikz_vcca_xiy}\input{PaperB/appendix/figures/tikz_figures/vcca_xiy}} ~~~~
         \\
         \subfigure[VCCA$_{x w}$]{\label{fig:tikz_vcca_xw}\input{PaperB/appendix/figures/tikz_figures/vcca_xw}} 
         \subfigure[VCCA$_{x w y}$]{\label{fig:tikz_vcca_xwy}\input{PaperB/appendix/figures/tikz_figures/vcca_xwy}} ~~~~
         \subfigure[VCCA$_{x i w}$]{\label{fig:tikz_vcca_xiw}\input{PaperB/appendix/figures/tikz_figures/vcca_xiw}}
         ~~~~
         \subfigure[VCCA$_{x i w y}$]{\label{fig:tikz_vcca_xiwy}\input{PaperB/appendix/figures/tikz_figures/vcca_xiwy}} ~~~~
         \\
         \subfigure[VCCA-private$_{x i}$]{\label{fig:tikz_vcca_private_xi}\input{PaperB/appendix/figures/tikz_figures/vcca_private_xi}}
         ~~~~ 
         \subfigure[VCCA-private$_{x i y}$]{\label{fig:tikz_vcca_private_xiy}\input{PaperB/appendix/figures/tikz_figures/vcca_private_xiy}}
         ~~~~ 
         \subfigure[VCCA-private$_{x w}$]{\label{fig:tikz_vcca_private_xw}\input{PaperB/appendix/figures/tikz_figures/vcca_private_xw}}
         ~~~~ 
         \subfigure[VCCA-private$_{x w y}$]{\label{fig:tikz_vcca_private_xwy}\input{PaperB/appendix/figures/tikz_figures/vcca_private_xwy}} ~~~~
    \end{minipage}
