...
\begin{figure}[t!]
    ...
    \begin{minipage}[t]{\textwidth}
        ...
        \begin{subfigure}[t]{0.21\textwidth}
        	\centering
        	\input{PaperB/appendix/figures/tikz_figures/vae_x}
    	...
    	\begin{subfigure}[t]{0.21\textwidth}
    		\centering
    		\input{PaperB/appendix/figures/tikz_figures/vae_xy}
    	%\includegraphics[width=\textwidth]{PaperB/appendix/figures/tikz_figures/vae_x}
    	\caption{VCCA$_{x y}$}
        ...
        \begin{subfigure}[t]{0.20\textwidth}
         ...
         \begin{subfigure}[t]{0.20\textwidth}
         	\centering
         	\input{PaperB/appendix/figures/tikz_figures/vcca_xwy}
         	%\includegraphics[width=\textwidth]{PaperB/appendix/figures/tikz_figures/vae_x}
         ...
         \begin{subfigure}[t]{0.20\textwidth}
         	\centering
         	\input{PaperB/appendix/figures/tikz_figures/vcca_xiwy}
         	%\includegraphics[width=\textwidth]{PaperB/appendix/figures/tikz_figures/vae_x}
     	...
     	\begin{subfigure}[t]{0.21\textwidth}
     		\centering
     		\input{PaperB/appendix/figures/tikz_figures/vcca_private_xw}
     		%\includegraphics[width=\textwidth]{PaperB/appendix/figures/tikz_figures/vae_x}
     		\caption{VCCA-private$_{x w}$}
     	...
     	\begin{subfigure}[t]{0.21\textwidth}
     		\centering
     		\input{PaperB/appendix/figures/tikz_figures/vcca_private_xwy}
     		%\includegraphics[width=\textwidth]{PaperB/appendix/figures/tikz_figures/vae_x}
     		\caption{VCCA-private$_{x w y}$}
