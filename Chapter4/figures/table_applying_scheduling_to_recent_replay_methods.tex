...
\caption{
    ...
    Memory sizes are $M=10$ and $M=100$ for the 5-task and 10/20-task datasets respectively. We report the mean and std. averaged over 5 seeds. $^{*}$ denotes where some seed in Heuristic did not converge.  %Applying RS-MCTS to each method can enhance the performance compared to using the baseline schedules. 
}
\vspace{-3mm}
