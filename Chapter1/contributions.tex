...
\MK{Would be nice to have a figure for every paper. Paper A could have a Google Maps picture over the stores I visited perhaps. Paper B perhaps the PCA visualizations. Paper C and D should have a sketch over the general idea describing the proposed CL scenario and the Policy Learning pipeline respectively. }
