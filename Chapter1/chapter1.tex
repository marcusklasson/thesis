...
\begin{table}[t]
	\centering
	\caption{Two examples of grocery item classes in the Grocery Store dataset presented in Paper \ref{paperA}. We display two class labels (coarse-grained class in parenthesis), two natural images taken with a mobile phone inside grocery stores, and the web-scraped iconic images and text description of the items. }
	\vspace{-10pt}
