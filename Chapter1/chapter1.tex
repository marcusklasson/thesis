...
This thesis focuses on two challenges for assistive vision technologies that have been coined in the machine learning community as \textit{fine-grained classification} and \textit{continual learning}. 
