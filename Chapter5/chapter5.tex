...
There are many interesting challenges that remains to tackle in federated learning. 
...
%Li \etal~\cite{li2020federated} mentions challenges with statistical heterogeneity in the data from different users~\cite{smith2017federated, zhao2018federated}, 
%variability of the systems on each device~\cite{bonawitz2019towards}, 
%privacy concerns~\cite{mcmahan2017communication}, %~\cite{geyer2017differentially}, %bhowmick2018protection}, 
...
%%% Or if we should focus on different settings, such as object recognition in home environments, since both VI and sighted people may be uncomfortable with the usage of assistive vision devices in public spaces. 
...
\section{Final Words}\label{chap5:sec:final_words}
