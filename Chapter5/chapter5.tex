...
% limitations: better with taking videos isntead of images, more annotations where the target class is, are there multiple instances of the target class, are there different classes in the images. 
