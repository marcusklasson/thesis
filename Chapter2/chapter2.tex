...
\paragraph{Recurrent Neural Networks.} For handling sequential data, we need to take into account that data on previous points in time may have an effect on future outcomes.  
