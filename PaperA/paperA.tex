...
%%% Contents
\input{PaperA/sections/introduction}
\input{PaperA/sections/related_work}
\input{PaperA/sections/our_dataset}
\input{PaperA/sections/classification_methods}
\input{PaperA/sections/experimental_results}
\input{PaperA/sections/conclusions}

\renewcommand*{\bibname}{References}
\bibliographystyleA{unsrt}
{\small
\bibliographyA{PaperA/refA}
}